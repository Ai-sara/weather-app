...
hourlyWeatherHTML = document.querySelector(".hourly-weather .weather-list")

const API_KEY = "a07000e63d214e77905145357241510";
...
const displayHourlyForecast = (hourlyData) =>{
    ...
    hourlyWeatherHTML.innerHTML = next24HoursData.map(item => {
        ...
        return `    <li class="weather-item">
                        <p class="time">${time}</p>
                        <img src="./images/${weatherIcon}.svg" width="50" height="50" alt="" class="weather-icon">
...
const getWeatherDetails = async (API_URL) =>{
    ...
    try{
        ...
        const combineHourlyDate = [...data.forecast.forecastday[0].hour, ...data.forecast.forecastday[1].hour];

        displayHourlyForecast(combineHourlyDate);
